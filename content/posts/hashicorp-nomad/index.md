...
cover:
  image: 'adi-yusuf-j-UTH7jAnUs-unsplash.jpg'
...
## Introduction
In previous articles I introduced [Packer](https://jessequinn.infoarticles/hashicorp-packer) and 
[Terraform](https://jessequinn.infoarticles/hashicorp-terraform). In those two articles I did not discuss the files that 
